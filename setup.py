...
if platform.system() == "Darwin":
    ...
    CXX_SYSTEM_INCLUDE_SDK_DIR = os.path.join(TOOLCHAIN_DIR, "SDKs/MacOSX.sdk/usr/include")

    CLIF_CXX_FLAGS += f" -isystem {CXX_SYSTEM_INCLUDE_DIR} -isystem {CXX_SYSTEM_INCLUDE_SDK_DIR}"
